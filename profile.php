...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- left column -->
        <!-- edit form column -->
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main personal-info">
            ...
            <form class="form-horizontal" role="form" method="POST" action="./core/edit_profile.php">
                <div class="form-group">
                    <label class="col-lg-3 control-label">Email:</label>
                    <div class="col-lg-8">
                        <input class="form-control" type="text" name="inputemail" value="<?php echo $row['email']?>" disabled>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">Username:</label>
                    <div class="col-md-8">
                        <input class="form-control" type="text" name="inputname" value="<?php echo $row['name']?>" disabled>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">Password:</label>
                    <div class="col-md-8">
                        <input class="form-control" type="password" name="inputpassword" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">Confirm password:</label>
                    <div class="col-md-8">
                        <input class="form-control" type="password" name="inputrepassword" value="">
                    </div>
                </div>
                <div class="form-group">
